...
// }
   ...
   //To delete LOG
    if(isset($_GET['delete_id']))
	{
		...
		$stmt_select = $DB_con->prepare('SELECT * FROM user_activity WHERE id =:id');
		$stmt_select->execute(array(':id'=>$_GET['delete_id']));
	
		$stmt_delete = $DB_con->prepare('DELETE FROM user_activity WHERE id =:id');
            ...
            <div class="col-sm-12">
                  <div class="card">
                     <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                           <h4 class="card-title"><b>Employee Activity History</b></h4>
                        </div>
                     </div>
                     <div class="card-body">
                           <div class="row justify-content-between">
                              ...
                              <div class="col-sm-6 col-md-6">
                                 ...
                                 <!--<a style="background:#fff200;color:black;" href="department-add" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add new department" href="#"><i class="ri-user-add-line"></i>Activity History</a>
                                 -->  <a style="background:#fff200;color:black;" href="user_logs"> <b><i class="las la-list-alt"></i>&nbsp;&nbsp;&nbsp;Log History </b> </a>
                                 </div>
                              </div>
                    ...
                    $stmt = $DB_con->prepare('SELECT * FROM user_activity ORDER BY id DESC');
                    $stmt->execute();
                    ...
                    ?>
                                ...
                                <td><?php echo htmlentities($cnt);?></td>
											...
											<td><?php echo htmlentities($row['created_time']); ?></td>
                            ...
                            <td>       
                                <div class="flex align-items-center list-user-action">
                                             ...
                                             <a class="iq-bg-warning" href="?delete_id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" onclick="return confirm('Are you sure to remove this LOG?')" href="#"><i class="ri-delete-bin-line"></i></a>
                                </div>                       
                  </td>
                            <?php $cnt=$cnt+1; ?>
                    </tr>
