                        ...
                        <form>
                           ...
                           <div class="img-extension mt-3">
                              <div class="d-inline-block align-items-center">
                                 ...
                                 <a style="color:green"><b>HR/Admins.</b></a>
                              </div>
                           </div>
                           </div>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="new-user-info">
                           <form action="department_save.php" method="post" enctype="multipart/form-data">
                              <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="deptmanager" class="form-control" name ="deptmanager" id="deptmanager" placeholder="Department Manager" required>                                    
                                 </div>
                              ...
                              <button type="submit" class="btn btn-" style="background:#fff200;color:black;" name="department_save">Add Department</button>
                           </form>
                        </div>
                     </div>
                  </div>
