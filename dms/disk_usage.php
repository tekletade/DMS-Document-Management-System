            ...
            <div class="col-sm-12">
                  <div class="card">
                     <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                           <h4 class="card-title">Disk Analysis</h4>
                        </div>
                     </div>
                     <?php
                        $sql_query4 = "SELECT SUM(disksize_given) FROM department";
                        $sizesum2 = mysqli_query($dbcon,$sql_query4);
                        $sumsize2 = mysqli_fetch_array($sizesum2);
                        $totalgiven = $sumsize2[0];

                        $sql_query4 = "SELECT SUM(disk_used) FROM department";
                        $sizesum2 = mysqli_query($dbcon,$sql_query4);
                        $sumsize2 = mysqli_fetch_array($sizesum2);
                        $tdisk_used = $sumsize2[0];
                        $totalfree = $totalgiven - $tdisk_used;
                     ...
                     <div class="card-body">
                           <div class="row justify-content-between">
                              <div class="col-sm-6 col-md-6">
                                 <div id="user_list_datatable_info" class="dataTables_filter">
                                    <form class="mr-3 position-relative">
                                       ...
                                       <!-- <h4 style ="color:green" class="card-title">Total Given Disk:<b> <?php echo $totalgiven/1024/1024/1024. ?> GB</b></h4> -->
                                          <input style ="color:green" class="form-control" id="" value="Total Given Disk: <?php echo formatSizeInGB($totalgiven) ?> | Total Used Disk: <?php echo formatSizeInGB($tdisk_used) ?> | Free Space: <?php echo formatSizeInGB($totalfree) ?>" readonly>
                                       </div>
                                    </form>
                                 </div>
                              </div>
                              <div class="col-sm-6 col-md-6">
                                 ...
                                 <a style="background:#fff200;color:black" href="department.php" data-toggle="tooltip" data-placement="top" title="" data-original-title="Back" href="#">Back to Departments</a>
                                 </div>
                              </div>
                           ...
                           <div class="table-responsive">
                              ...
                              <?php $i=1;?>
                                    <tr>
                                       ...
                                       <th scope="col">Total Given Disk/GB</th>
                    ...
                    $stmt = $DB_con->prepare('SELECT * FROM department ORDER BY id ASC');
                    $stmt->execute();
                    ...
                    ?>
                                ...
                                <td><?php echo formatSizeInGB($disk_used); ?></td>                                                  
                                <td><?php echo formatSizeInGB($disksize_given-$disk_used); ?></td>                                                      
                                ...
                                <!-- <div class="flex align-items-center list-user-action"> -->
                                             ...
                                             <!-- <a class="iq-bg-primary" href="department-edit.php?edit_id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="#"><i class="ri-pencil-line"></i></a>
