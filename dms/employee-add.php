                        ...
                        <form>
                           ...
                           <div class="img-extension mt-3">
                              <div class="d-inline-block align-items-center">
                                    <span>Only</span>
                                 <a style="color:#fff200"><b>allowed for Admins/HR.</b></a>
                              </div>
                           </div>
                           </div>
                           ...
                           <form action="employee_save.php" method="post" enctype="multipart/form-data">
                              <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="email" class="form-control" name ="email"id="email" placeholder="EMail/Droga Mail" required>                                    
                                 </div>
                                 
                                 <div class="form-group col-md-6">
                                    <label for="password">Password: Default=P@$$w0rd</label>
                              ...
                              <label for="drogaid">Droga ID:</label>
                                <div class="form-groups col-md-6">                                    
                                    <!--<span class="border-end country-code px-2">DP</span>-->
                                    <input type="text" class="form-control" name="drogaid" id="drogaid" aria-describedby="emailHelp" placeholder="eg.DP0279" required/>
                                </div>  
                              ...
                              <button type="submit" class="btn btn-" style="background:#fff200;color:black;" name="employee_save">Add Employee</button>
                           </form>
                        </div>
                     </div>
                  </div>
