                        ...
                        <form>
                           ...
                           <div class="img-extension mt-3">
                              <div class="d-inline-block align-items-center">
                                    <span>Only</span>
                                 <a style="color:#fff200"><b>allowed for Admins and Team Managers.</b></a>
                              </div>
                           </div>
                           </div>
                        ...
                        <form method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row">
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name = "name" id="fullname" value="<?php echo $name; ?>" required>
                                 </div>
                                 ...
                                 <!-- <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="password" id="pass" value=<?php echo md5($password); ?>  required>
                                 </div> -->
                              </div>
                              
                                <div class="form-group col-md-6">
                                    <label for="drogaid">Company ID:</label>
                                    <input type="text" class="form-control" name = "drogaid" id="drogaid" value="<?php echo $id; ?>" required>
                                 </div> 
                            
                                 <div class="form-group col-md-6">
                                 </div>                              
                              
                              <button type="submit" class="btn btn-" style="background:#fff200;color:black" name="employee_edit">Update</button>
                           </form>
                        </div>
                     </div>
                  </div>
