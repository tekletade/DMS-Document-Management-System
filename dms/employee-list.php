...
if(!$_SESSION['id'])
{
   ...
   header("Location: ../index");
    ...
    if($row1['type'] =='Member Employee' && $row1['department'] != 'HRM')
	{
	  header("Location: index");
	}
  ...
  //  '".$_SESSION['id']."' = $_SESSION['id'];
	...
	if(isset($_GET['delete_id']))
	{
		...
		$stmt_select = $DB_con->prepare('SELECT name FROM users WHERE id =:id');
    ...
    //To reset the pwd   
        ...
        if (isset($_GET['reset_id'])) {
            ...
            $sql = "UPDATE users SET password = '$password' WHERE id = $reset_id";
            ...
            if ($dbcon->query($sql) == TRUE) {
                ...
                echo "Error updating status: " . $dbcon->error;
                header("Location: employee-list");
            }
            $dbcon->close();
        }
         ...
         <div class="row">
            <div class="col-sm-12">
                  <div class="card">
                           ...
                           <div class="row justify-content-between">
                              ...
                              <div class="col-sm-6 col-md-6">
                                 <div class="user-list-files d-flex">
                                    <a style="background:#fff200;color:black" href="employee-add" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add new employee" href="#"><i class="ri-user-add-line"></i>Add New Employee</a>
                                    <!--<a class="bg-primary" href="javascript:void();" > Print </a>-->
                                 </div>
                              </div>
                           </div>
                           <br>
                    ...
                    if ($type2 == 'Admin' || $department2 == 'HRM' || $type2 == 'CEO' || $type2 == 'CEO Deputy' ){
                        $stmt = $DB_con->prepare("SELECT * FROM users ORDER BY id ASC");
                    }
                    else if($type2 == 'Team Manager' && $department2 !='HRM' ){

                    $stmt = $DB_con->prepare("SELECT * FROM users where department = '$department2' ORDER BY id ASC");
                    ...
                    ?>
                                ...
                                <td>       
                                    <div class="flex align-items-center list-user-action">
                                                <!-- <a class="iq-bg-primary" href="employee-add.php" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add" href="#"><i class="ri-user-add-line"></i></a> -->
                                                <a class="iq-bg-primary" href="employee-edit?edit_id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="#"><i class="ri-pencil-line"></i></a>
                                                <a class="iq-bg-warning" href="?delete_id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" onclick="return confirm('Are you sure to remove this Employee?')" href="#"><i class="ri-delete-bin-line"></i></a><br>
                                                <a class="iq-bg-info" href="?reset_id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Password Reset" onclick="return confirm('Are you sure to Reset the Password?')" href="#">ResetPWD</a>
