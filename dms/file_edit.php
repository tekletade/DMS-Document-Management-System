...
if(!$_SESSION['id'])
{
   ...
   header("Location: ../index");
    ...
    {
        $id = $_GET['edit_id'];
        $stmt_edit = $DB_con->prepare('SELECT * FROM department WHERE id =:id');
    ...
    if(isset($_POST['department_edit']))
    {
        ...
        $dept_manager = $_POST['dept_manager'];
            ...
            $stmt = $DB_con->prepare('UPDATE department
                                         SET dept_name=:dept_name,
                                             dept_manager=:dept_manager                                             									 
                                       WHERE id=:id');
            $stmt->bindParam(':dept_name',$dept_name); 
            $stmt->bindParam(':dept_manager',$dept_manager);       
...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>DMS-Edit Departments</title>
          ...
          <div class="data-scrollbar" data-scroll="1">
                <div class="new-create select-dropdown input-prepend input-append">
                  <div class="btn-group">
                      ...
                      <div style="background-color:silver"class="search-query selet-caption"><i class="las la-plus pr-2"></i>Create New</div><span class="search-repblace"></span>
                      <span class="caret"><!--icon--></span>
                      </div>
                      <ul class="dropdown-menu">
                          <li><div data-toggle="modal" class="item" data-target="#newfolder" ><i class="ri-folder-add-line pr-3"></i>New Folder</div></li>
                          <li><div data-toggle="modal" class="item" data-target="#newfile" ><i class="ri-folder-add-line pr-3"></i>Upload Files</div></li>
                      </ul>
                  </div>
              </div>
              <nav class="iq-sidebar-menu">
                  ...
                  <li class="active">
                              <a style="color:black" href="../index" class="">
                                  <i class="ri-dashboard-fill iq-arrow-left"></i><span>Dashboard</span>
                              </a>
                       ...
                       <li class=" ">
                          <a style="color:black" href="#mydrive" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            ...
                            <?php 
                                $foldernav = $dbcon->query("SELECT * FROM folders where shared_id != '".$_SESSION['id']."' and shared_id = $folder_parent and publicity ='Public'and user_id !='".$_SESSION['id']."' or parent_id = $folder_parent and shared_id != '".$_SESSION['id']."' and user_id = '".$_SESSION['id']."' OR publicity= 'public' and parent_id = $folder_parent and shared_id != '".$_SESSION['id']."' OR publicity= '".$row1['department']."' and parent_id = $folder_parent and shared_id != '".$_SESSION['id']."' or publicity= '".$_SESSION['id']."' and parent_id = $folder_parent and shared_id != '".$_SESSION['id']."' order by folder_name asc");
                                    ...
                                    <li class=" " data-id="<?php echo $rownav['id'] ?>">
                                          <a href="folder_detail.php?id=<?php echo $rownav['id'] ?>">
                       ...
                       <li class=" ">
                              <a style="color:black" href="files" class="">
					   ...
					   -->
                       <li class=" ">
                              <a style="color:black" href="archive" class="">
                      ...
                      <!-- <li class=" ">
                       ...
                       {?>
                       <li class=" ">
                          <a style="color:black" href="#employee" class="collapsed" data-toggle="collapse" aria-expanded="false">
                       ...
                       {?>
                       <li class=" ">
                              <a style="color:black" href="department" class="">
              ...
              <div class="sidebar-bottom">
                  ...
                  <div class="iq-progress-bar mb-3">
                      <span class="bg-green" data-percent=<?php echo round($percentageUsed, 2)?>>
                      </span>
                  </div>
                  <p> <?php echo formatSizeInGB($used)?> of <?php echo formatSizeInGB($totalgiven)?> Used</p>
                  <a href="#" class="btn btn-outline-success view-more mt-4">Extend Storage</a>
              </div>
              <div class="p-3"></div>
          </div>
          </div>       
                      ...
                      <div class="collapse navbar-collapse" id="navbarSupportedContent">
                          ...
                          <li class="nav-item nav-icon dropdown caption-content">
                              <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                                  <div class="caption bg-success line-height"><b><?php echo $firstLetter; ?></b></div>
                              </a>
                              <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton03">
                                  <div class="card mb-0">
                                      ...
                                      <div class="close-data text-right badge badge-danger cursor-pointer "><i class="ri-close-fill"></i></div>
                                      </div>
                                      <div class="card-body">
                                          <div class="profile-header">
                                              <div class="cover-container text-center">
                                                  <div class="rounded-circle profile-icon bg-warning mx-auto d-block">
                        ...
                        <form>
                           ...
                           <div class="img-extension mt-3">
                              <div class="d-inline-block align-items-center">
                                    <span>Only</span>
                                 <a style="color:green"><b>allowed for Admins.</b></a>
                              </div>
                           </div>
                           </div>
                        ...
                        <form method="post" enctype="multipart/form-data" class="form-horizontal">
                              <div class="row">
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name = "dept_name" id="deptname" value=<?php echo $dept_name ?> required>
                                 </div>

                                 <div class="form-group col-md-6">
                                    <label for="deptmanager">Department Manager:</label>
                                    <input type="deptmanager" class="form-control" name ="dept_manager" id="deptmanager" value=<?php echo $dept_manager ?> required>                                    
                                 </div>
                              ...
                              <button type="submit" class="btn btn-success" name = "department_edit"> Update</button>
                           </form>
                        </div>
                     </div>
                  </div>
