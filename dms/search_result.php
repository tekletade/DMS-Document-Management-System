...
if(!$_SESSION['id'])
{
   ...
   header("Location: ../index");
	...
	$files = $dbcon->query("SELECT * FROM files where shared_id != '".$_SESSION['id']."' and user_id ='".$_SESSION['id']."' and name like '$find' or publicity='Public' and name like '$find' or publicity='".$_SESSION['id']."' and name like '$find'");
      ...
      <div class="content-page">
        <div class="container-fluid">
			...
			<!---->
			 ...
			 <?php
               	$files2 = $dbcon->query("SELECT * FROM files where shared_id != '".$_SESSION['id']."' and user_id ='".$_SESSION['id']."' and name like '$find' or publicity='Public' and name like '$find' or publicity='".$_SESSION['id']."' and name like '$find'");
