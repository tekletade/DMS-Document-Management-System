...
if(!$_SESSION['id'])
{
   ...
   header("Location: ../index");
	...
	{
		$id = $_GET['share_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM folders WHERE id =:id');
		$stmt_edit->execute(array(':id'=>$id));
		$share_row = $stmt_edit->fetch(PDO::FETCH_ASSOC);
		extract($share_row);
        $foldername= $share_row['folder_name'];
	}
	else
	{
...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>DMS-Add Departments</title>
                     ...
                     <div class="card-body">
                        <div class="new-user-info">
                           <form action="share_done.php" method="post" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="folder_name" value="<?php echo $share_row['folder_name'];?>">
                                <input type="hidden" name="department" value="<?php echo $share_row['department'];?>">
                                <input type="hidden" name="parent_id" value="<?php echo $_GET['share_id']; ?>">

                                
                                <div class="row">
                                 <div class="form-group col-md-6">
                                    <label for="foldername">Folder Name: <b style="color:green"><?php echo $foldername?></b></label>
                                    <input type="text" class="form-control" name = "foldername" id="foldername" placeholder = <?php echo $share_row['department'] .':Department-file' ?> readonly>
                                 </div>                              
                                 
                                 <div class="form-group col-md-6">
                                    <label for="owner">Owner:<b style="color:green"><?php echo $share_row['user_name'];?></b></label>
                                    <input type="text" class="form-control" name = "owner" id="owner" placeholder= <?php echo 'Owner-Id:'.$share_row['user_id'];?> readonly>
                                </div>
                                 ...
                                 <ul class="list">
                                    <li>
                                     <div class="header"><i class="ri-share-fill mr-2"></i>&nbsp;Share to Public:</div>
                                        <ul class="content">
                                            <br>
                                            <button type="submit" class="btn btn-" style="background:#fff200;color:black;" name="sharepublic">Done</button>
                                        </ul>
                                   </li>
                                   <br>
                                   ...
                                   <li>
                                    <div class="header"><i class="ri-share-fill mr-2"></i>&nbsp;Share to Individual:</div>
                                       ...
                                       <select name="sharename" id="select-state" placeholder="Add an Employee...">
                                        ...
                                        <br>
                                        <button type="submit" class="btn btn-" style="background:#fff200;color:black;" name="shareindividual">Done</button>
                                    ...
                                    <li>
                                       ...
                                       <select name="access_name" id="select-state2" placeholder="Add department...">
                                        ...
                                        <br>
                                        <button type="submit" class="btn btn-" style="background:#fff200;color:black;" name="sharegroup">Done</button>
