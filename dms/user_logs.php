            ...
            <div class="col-sm-12">
                  <div class="card">
                     <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                           <h4 class="card-title"><b>Employee Log History</b></h4>
                        </div>
                     </div>
                     <div class="card-body">
                           <div class="row justify-content-between">
                              ...
                              <div class="col-sm-6 col-md-6">
                                 ...
                                 -->  <a style="background:#fff200;color:black;" href="activity_log"> <b><i class="las la-list-alt"></i>&nbsp;&nbsp;&nbsp;Activity History </b> </a>
                                 </div>
                              </div>
                    ...
                    $stmt = $DB_con->prepare('SELECT * FROM user_log ORDER BY id DESC');
                    $stmt->execute();
                    ...
                    ?>
                                ...
                                <td><?php echo htmlentities($cnt);?></td>
											...
											<td><?php echo htmlentities($row['logout_time']); ?></td>
